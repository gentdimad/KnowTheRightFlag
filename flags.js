...
function namericaButton() {
  $("#namerica").on("click", function () {
    ...
    $("#question_description").html(
      "This country is the world's largest national economy and leading global trader."
    );
...
function samericaButton() {
  $("#samerica").on("click", function () {
    ...
    $("#question_description").html(
      "This country is home to the world-famous Amazon Rainforest."
    );
...
function australiaButton() {
  $("#australia_button").on("click", function () {
    ...
    $("#question_description").html(
      "This country has the same name as the continent it is on!"
    );
    $("#choice_1").html("USA");
...
function africaButton() {
  $("#africa").on("click", function () {
    ...
    $("#question_description").html(
      "This country holds the largest natural gas reserves on the continent!"
    );
    $("#choice_1").html("Congo");
    $("#choice_2").html("Peru");
...
function antarcticaButton() {
  $("#antarctica").on("click", function () {
    ...
    $("#question_description").html(
      "Antarctica has no countries. This is one of the countries that claims it. It has the world's largest swimming pool!"
    );
    $("#choice_1").html("Chile");
...
function genderPlayButton() {
  $("#gender_play").on("click", function () {
    ...
    $("#question_flag").attr(
      "src",
      "https://assets.volvo.com/is/image/VolvoInformationTechnologyAB/image7"
    );
    $("#question_description").html(
      "This is used to represent people whose gender identity does not fit within the traditional male/female binary."
    );
  ...
  if (content == "asia") {
    switch (question) {
      case 2: {
        $("#question_flag").attr(
          "src",
          "https://e0.pxfuel.com/wallpapers/911/753/desktop-wallpaper-japan-flag-japanese-flag-flag-of-japan-japan.jpg"
        );
        $("#question_description").html(
          "This country is home to the famous cherry blossoms!"
        );
        $("#choice_1").html("China");
        $("#choice_2").html("Japan");
      ...
      case 3: {
        ...
        $("#question_description").html(
          "This country has 7641 islands- making it one of the world's largest archipelagos!"
        );
      ...
      case 4: {
        ...
        $("#question_description").html(
          "This country is considered the world's most mountainous island!"
        );
        $("#choice_1").html("Taiwan");
  ...
  if (content == "namerica") {
    switch (question) {
      case 2: {
        $("#question_flag").attr(
          "src",
          "https://cdn.britannica.com/68/7068-050-54679E29/Flag-Canada.jpg"
        );
        $("#question_description").html(
      ...
      case 3: {
        $("#question_flag").attr(
          "src",
          "https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/Flag_of_Greenland.svg/2000px-Flag_of_Greenland.svg.png"
        );
        $("#question_description").html(
          "This country has the second-largest ice sheet next to Antarctica!"
        );
        $("#choice_1").html("USA");
      ...
      case 4: {
        ...
        $("#question_description").html(
          "This country is home to the world's largest pyramid!"
        );
        $("#choice_1").html("Egypt");
  ...
  if (content == "samerica") {
    switch (question) {
      case 2: {
        $("#question_flag").attr(
          "src",
          "https://cdn.britannica.com/04/4904-050-4D71EA82/Flag-Venezuela.jpg"
        );
        $("#question_description").html(
          "This country has the largest oil reserves in the whole world!"
        );
      ...
      case 3: {
        $("#question_flag").attr(
          "src",
          "https://cdn.britannica.com/77/3377-050-F05BF1D9/Flag-Paraguay.jpg"
        );
        $("#question_description").html(
          "This country is known as The Heart of South America!"
        );
        $("#choice_1").html("Peru");
      ...
      case 4: {
        $("#question_flag").attr(
          "src",
          "https://cdn.britannica.com/48/3448-050-1EFC8CF3/Flag-Peru.jpg"
        );
        $("#question_description").html(
          "This country has the tallest sand dunes in the world!"
        );
        $("#choice_1").html("Egypt");
  ...
  if (content == "australia") {
    switch (question) {
      case 2: {
        $("#question_flag").attr(
          "src",
          "https://cdn.britannica.com/08/3308-050-9DB345F2/Flag-Samoa.jpg"
        );
        $("#question_description").html(
          "This country is known as The Cradle of Polynesia."
        );
        $("#choice_1").html("Tonga");
        $("#choice_2").html("Samoa");
      ...
      case 3: {
        ...
        $("#question_description").html(
          "This country is the only monarchy in Australia!"
        );
        $("#choice_1").html("Wales");
        $("#choice_2").html("United Kingdom");
        $("#choice_3").html("Tonga");
      ...
      case 4: {
        $("#question_flag").attr(
          "src",
          "https://cdn.britannica.com/98/3298-050-9F44CA8A/Flag-Solomon-Islands.jpg"
        );
        $("#question_description").html(
          "This country got its name because it was believed to be the home of the riches of a biblical king!"
        );
  ...
  if (content == "europe") {
    switch (question) {
      case 2: {
        ...
        $("#question_description").html(
          "This is the country of artists of universal renown such as Velázquez, Goya, Gaudí, Picasso, and Dalí."
        );
        $("#choice_1").html("Italy");
        $("#choice_2").html("Spain");
      ...
      case 3: {
        ...
        $("#question_description").html(
          "This country is the oldest country in Europe!"
        );
      ...
      case 4: {
        ...
        $("#question_description").html(
          "This country's people invented pizza!"
        );
  ...
  if (content == "africa") {
    switch (question) {
      case 2: {
        ...
        $("#question_description").html(
          "This country has no permanent rivers!"
        );
      ...
      case 3: {
        $("#question_flag").attr(
          "src",
          "https://cdn.britannica.com/18/18-004-43399622/Flag-Somalia.jpg"
        );
        $("#question_description").html(
          "This country is known as The Land of the Moon."
        );
      ...
      case 4: {
        $("#question_flag").attr(
          "src",
          "https://cdn.britannica.com/12/4212-004-EBD6B5B2/Flag-Angola.jpg"
        );
        $("#question_description").html(
          "This country is home to the unique Imbondeiro tree."
        );
  ...
  if (content == "antarctica") {
    switch (question) {
      case 2: {
        ...
        $("#question_description").html(
          "This country was the last country to ever be inhabited by humans."
        );
        $("#choice_1").html("Australia");
      ...
      case 4: {
        ...
        $("#question_description").html(
          "This country is the highest meat-eating country in the whole world!"
        );
        $("#choice_1").html("USA");
  ...
  if (content == "gender") {
    switch (question) {
      case 2: {
        $("#question_flag").attr(
          "src",
          "https://assets.volvo.com/is/image/VolvoInformationTechnologyAB/image8"
        );
        $("#question_description").html(
      ...
      case 3: {
        $("#question_flag").attr(
          "src",
          "https://assets.volvo.com/is/image/VolvoInformationTechnologyAB/image9"
        );
        $("#question_description").html(
          "It is the lack of sexual attraction to others, or a low interest in sexual activity, but it can mean different things to different people"
        );
      ...
      case 4: {
        $("#question_flag").attr(
          "src",
          "https://assets.volvo.com/is/image/VolvoInformationTechnologyAB/image10"
        );
        $("#question_description").html(
          "It represents the way that these people can blend into the straight community and the gay community."
        );
      ...
      case 5: {
        $("#question_flag").attr(
          "src",
          "https://assets.volvo.com/is/image/VolvoInformationTechnologyAB/image11"
        );
        $("#question_description").html(
          "They may refer to themselves as gender-blind, asserting that gender and sex are not determining factors in their romantic or sexual attraction to others."
        );
        $("#choice_1").html("Bigender");
      ...
      case 6: {
        $("#question_flag").attr(
          "src",
          "https://assets.volvo.com/is/image/VolvoInformationTechnologyAB/image12"
        );
        $("#question_description").html(
          "This refers to a woman who has a romantic and/or sexual orientation toward women."
        );
        $("#choice_1").html("Transgender");
      ...
      case 7: {
        $("#question_flag").attr(
          "src",
          "https://assets.volvo.com/is/image/VolvoInformationTechnologyAB/image15"
        );
        $("#question_description").html(
          "This is for those most viewed as men attracted to women and women attracted to men."
        );
      ...
      case 8: {
        $("#question_flag").attr(
          "src",
          "https://assets.volvo.com/is/image/VolvoInformationTechnologyAB/bigender-pride-flag-1"
        );
        $("#question_description").html(
      ...
      case 9: {
        $("#question_flag").attr(
          "src",
          "https://assets.volvo.com/is/image/VolvoInformationTechnologyAB/transgender"
        );
        $("#question_description").html(
          "This people have a gender identity or gender expression that differs from the sex that they were assigned at birth."
        );
      ...
      case 10: {
        $("#question_flag").attr(
          "src",
          "https://assets.volvo.com/is/image/VolvoInformationTechnologyAB/Grey-asexuality-flag"
        );
        $("#question_description").html(
          "This is used to describe a person who identifies themselves asexual but does not fall into one of the primary kinds of asexuality."
        );
      ...
      case 11: {
        $("#question_flag").attr(
          "src",
          "https://assets.volvo.com/is/image/VolvoInformationTechnologyAB/Genderflux-Pride-Flag"
        );
        $("#question_description").html(
          "This is for a catch-all phrase for gender identities where an individual's gender or sense of the intensity of their gender changes over time."
        );
        $("#choice_1").html("Transgender");
      ...
      case 12: {
        $("#question_flag").attr(
          "src",
          "https://assets.volvo.com/is/image/VolvoInformationTechnologyAB/image16"
        );
        $("#question_description").html(
          "This is for cisgender people who supports equal civil rights, gender equality, LGBT social movements, and challenges homophobia, biphobia and transphobia."
        );
        $("#choice_1").html("Bigender");
